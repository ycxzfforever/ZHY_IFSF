...
void Para_set()
{
    ...
    ttc=0;
    /*
    strcpy(conf.EPS_IP,"192.168.1.10");
    conf.EPS_Port=20002;
    strcpy(conf.FS_IP,"192.168.1.10");
    conf.FS_Port=27000;
    conf.FS_Udp_Port=3486;
    conf.Time_Out=10;
    conf.Time_Reconnect=5;
    strcpy(conf.My_IP,"192.168.1.197");
    conf.My_EPS_Port=5000;
    conf.My_FS_Port=6000;
    strcpy(conf.My_Mask,"255.255.255.0");
    strcpy(conf.My_Gateway,"192.168.1.1");
    strcpy(conf.My_Broadcast_IP,"192.168.1.255");
    conf.My_Broadcast_Port=3486;
    strcpy(conf.IFSF_Node,"02.01");
    strcpy(conf.My_Node,"01.03");
    strcpy(conf.Pay_Terminal_NO,"12345678");
    conf.Pri_Ver=0;
    strcpy(conf.Uart_NO,"/dev/ttyAT6");
    conf.Uart_Speed=9600;
    conf.Uart_Data_Bits=8;
